...
Paste everything below this line into the Project's custom instructions on your personal account.
...
Scheduled tasks handle these; their prompts live in this project's setup docs. In them you compile the trend, review yesterday honestly, set one focus, and teach.
